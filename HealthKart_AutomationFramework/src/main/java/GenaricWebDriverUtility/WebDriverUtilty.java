package GenaricWebDriverUtility;
 ...
 public void switctoAlertAccept(WebDriver driver) {
  ...
  public void select(WebElement element, String text) {
   ...
   public void movetoElement(WebDriver driver, WebElement element) {
	...
	public void sendData(WebDriver driver,WebElement element,String value) {
		JavascriptExecutor js=(JavascriptExecutor)driver;
		js.executeScript("arguments[0].value="+value,element);
		
		
	}
	public void selectByVisibleText(WebElement docSpecialization, String specialization) {
